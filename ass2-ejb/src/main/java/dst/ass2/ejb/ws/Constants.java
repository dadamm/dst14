...
public class Constants {
	...
	public static final String OP_ADD_TASK = "addTask";
	public static final String OP_GET_STATS = "getStatisticsForPlatform";
	public static final String OP_REMOVE_TASKS = "removeTasksForPlatform";
	public static final String OP_GET_CACHE = "getCache";
	public static final String OP_SUBMIT = "submitAssignments";
