...
public class RateTaskWrapperDTO implements Serializable {
	...
	public RateTaskWrapperDTO() {
	}

	public RateTaskWrapperDTO(Long id, Long taskId, LifecycleState state, String ratedBy,
	...
	public RateTaskWrapperDTO(ITaskWrapper task) {
		super();
		this.id = task.getId();
