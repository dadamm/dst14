...
@RunWith(Suite.class)
@SuiteClasses({ TestTablesSetup.class,
...
Test_1a01.class, Test_1a02.class, Test_1a03.class, Test_1a04.class,
		...
		Test_1a09.class, Test_1a10.class, Test_1b01.class, Test_1b02.class,

		Test_2a01_1.class, Test_2a01_2.class, Test_2a01_3.class,
		Test_2a02_1.class, Test_2a02_2.class, Test_2a02_3.class,
		Test_2a02_4.class, Test_2b01_1.class, Test_2b01_2.class,
		...
		TestEntity7.class, TestEntity2.class, TestEntity3.class,
		TestEntity6.class, TestEntity4.class, TestEntity1.class,
		TestEntity5.class, TestMembershipEntity.class, TestUserEntity.class })
