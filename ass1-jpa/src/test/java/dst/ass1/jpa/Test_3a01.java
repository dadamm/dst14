...
public class Test_3a01 {
	...
	public void testBuiltInConstaintsInvalid() {
		...
		ent3_1.setJoinedDate(createDate(2012, 01, 01));
		ent3_1.setLastTraining(createDate(2012, 01, 01));
	...
	public void testBuiltInConstaintsValid() {
		...
		ent3_1.setJoinedDate(createDate(2011,01, 01));
		ent3_1.setLastTraining(createDate(2011, 01, 01));
